...
| 1 | DIN 24 V PSU (optional) | 24 VDC, isolated, **current loops only**. Size for 2× 20 mA + transmitter quiescent | Site |
...
| Qty | Item | Example / notes | Est. |
| --- | --- | --- | --- |
| 1 | GP8413 dual 15-bit I2C 0–10 V DAC | DFRobot Gravity DFR1073 **or** Linearin GP8413 module/chip. **Not** a PWM RC filter | Buy |
| 2 | V/I transmitter (if 4–20 mA) | Isolated 0–10 V → 4–20 mA, loop from DIN 24 V. Alternate: GP8313 / GP8600 — see `OPEN_QUESTIONS.md` | TBD |
| 2 | 0.1 µF on each VOUT | Datasheet requirement if using bare GP8413 | |
| 2 | I2C pull-up 4.7 kΩ | 3.3 V | |

## Digital I/O

| Qty | Item | Example / notes | Est. |
| --- | --- | --- | --- |
| 2 | SPDT relay + MOSFET driver | 5 V coil, dry contacts for VFD RUN/FWD. AO3400 + 1N4148 flyback or a 2-ch relay board | Buy |
